            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formEdit" method="" action="">
                        @csrf
    <input type="text" value="{{$offer->id}}" name="ofer_id" style="display: none">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nameen" type="text" class="form-control"  name="name_en" value="{{$offer->name_en}}" >
                            </div>
                            @error('name_en')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="detailsen" type="text" class="form-control"  name="details_en" value={{$offer->details_en}}  >
